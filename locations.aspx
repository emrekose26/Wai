...
<body>
    ...
    <!--Main Page-->
        ...
        <section>
            ...
            <div id="locations-map" style="width: 990px; height: 527px; border:2px solid #000; position:absolute;right:60px;"></div>
            ...
            <article id="menu">
                ...
                <div class="list-group">
                    ...
                    <a href="locations.aspx" class="list-group-item active">
